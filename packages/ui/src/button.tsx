/* eslint-disable eslint-comments/require-description -- Unnecesarry */
...
const buttonTailwind = tv({
  slots: {
    base: "relative cursor-pointer rounded border-0 px-4 py-2 text-slate-50 transition-all duration-300",
  },
  variants: {
    buttonStyle: {
      outline: "border text-black hover:bg-neutral-200",
